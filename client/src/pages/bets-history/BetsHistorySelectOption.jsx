...
const BetsHistorySelectOption = () => {
  ...
  return (
    <div className="bg-[#262c32] p-4">
      ...
      {/* Top Section */}
      <div className="flex flex-row items-center justify-between gap-2 bg-[#262c32] text-white shadow-md mt-4">
...
export default BetsHistorySelectOption;
