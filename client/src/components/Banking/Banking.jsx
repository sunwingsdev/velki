  ...
  return (
    <div className="bg-adminBackground min-h-screen">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-300">
              <thead className="bg-headerGray text-headingTextColor">
                <tr>
                  <th className="border-y bg-yellow-400 border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">
                    UId
                  </th>
                  <th className="border-y bg-yellow-400 border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">
                    Available Balance
                  ...
                  <th className="border-y bg-yellow-400 border-gray-300 px-2 py-2 text-left text-sm font-medium uppercase">
                    Exposure in Downline
                  </th>
                  <th className="border-x bg-yellow-400   pl-16 py-2 text-left text-sm font-medium uppercase">
                    Deposit/withdraw
                  </th>
                  <th className="border-y bg-yellow-400 border-gray-300 px-2 py-2 text-left text-sm font-medium uppercase">
                    Credit Reference
                  ...
                  <th className=" border-l border-gray-600  bg-yellow-400  pl-2 py-2 text-right text-sm font-medium uppercase">
                    Remark{" "}
                  </th>
                  <th className="border-y bg-yellow-400 border-gray-300 pl-2 py-2 text-center text-sm font-medium uppercase">
                    <span className="bg-black p-2 text-yellow-400"> All</span>
                  </th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {data.map((row, index) => (
                  <tr key={index}>
                    <td className="border-b px-4 py-2 whitespace-nowrap text-sm text-gray-700">
                      <button
                        className={`w-6 h-6 font-sans text-white text-xs rounded-sm ${
                          [
                            "Demo",
                            "Agent 1",
                            "test tag 1",
                      ...
                      <div className="w-full mb-2 sm:mb-0">
                        <div className="flex flex-row gap-2 ">
                          <div className="flex flex-row items-center justify-center">
                            <button className="w-5 h-6 px-1  border-b border-l border-t border-black text-white bg-blue-500">
                              D
                            </button>
                            <button className="w-5 h-6 px-1 border border-black text-white bg-yellow-700">
                              w
                            </button>
                          </div>
                          <input
                            ...
                            placeholder="0"
                          />
                          <button className="w-8 h-6 px-1  border border-black text-black bg-yellow-400">
                            Full
                          </button>
                        </div>
                      </div>
                    ...
                    <td className="border-b lg:border-opacity-10 flex flex-row items-center justify-center  pr-0 py-2 whitespace-nowrap text-sm text-gray-700">
                      <button className="w-10 h-8 bg-blue-500  font-sans text-white  rounded-sm">
                        Login
                      </button>
                    </td>
                  </tr>
                ...
                <tr className="bg-headerGray text-headingTextColor">
                  ...
                  <td className=" border-l border-r border-gray-600  px-2 py-2 whitespace-nowrap text-sm text-gray-700">
                    800.00
                  </td>
                  <td className="   px-4 py-2 whitespace-nowrap text-sm text-gray-700">
                    500.00
      ...
      <div className="mt-8 mb-3 flex flex-col md:flex-row lg:flex-row items-center justify-center gap-3">
        <button className="border px-4 font-sans font-light border-black">
          clear all
        </button>
        <input
          className="border border-black placeholder:px-2 "
          type="password"
          name=""
          id=""
        ...
        <button className="bg-slate-800 text-yellow-400 px-12 h-6  ">
          Submit Payment
        </button>
      </div>
      <div className="  my-4 flex flex-row items-center justify-center gap-2">
        <button className="w-10 rounded-sm h-6 text-xs bg-white  border border-black">
          Prev
        </button>
        <button className="w-6 h-6  border text-yellow-400 bg-slate-800 border-black">
          1
        </button>
        <button className="w-4 h-4  border bg-white text-xs border-black">
          2
        </button>
        <button className="w-4 h-4  border bg-white text-xs border-black">
          3
        </button>
        <button className="w-4 h-5 border rounded-sm text-xs bg-white border-black">
          4
        </button>
        <button className="w-10 h-6 text-xs rounded-sm border bg-white border-black">
          Next
        </button>
      </div>
    </div>
