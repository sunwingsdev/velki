...
const AdminD = () => {
    ...
    const data = [
        ...
        { Account: "sports365AD", CreditRef: '8.40,933.62', balance: "1000.00", exposure: "200.00", availBalance: "800.00", playerBalance: "500.00", refPL: "+300.00", status: "Active", },
        ...
        { Account: "ariyanmax", CreditRef: '8.40,933.62', balance: "1000.00", exposure: "200.00", availBalance: "800.00", playerBalance: "500.00", refPL: "+300.00", status: "Active", },
        { Account: "WinbetUSD 1", CreditRef: '8.40,933.62', balance: "1000.00", exposure: "200.00", availBalance: "800.00", playerBalance: "500.00", refPL: "+300.00", status: "Active", },
    ]
            ...
            <div>
                <div className="navbar bg-base-100">
                    ...
                    <div className="pt-4 pl-4 flex flex-row gap-2">
                        <div className="form-control border bg-white border-black border-opacity-40 shadow-xl p-2 w-44 lg:w-auto rounded   ">
                            <input type="text" placeholder="Find Member" className="border-none focus:outline-none  w-24 h-4 pl-2 md:w-auto" />
                ...
                <div className="pt-2 pb-4 pl-4 flex flex-col lg:flex-row  justify-between gap-2">
                    ...
                    <div className="form-control flex flex-row border border-black bg-white border-opacity-40 shadow-xl p-2 rounded w-64   ">
                        <input type="text" placeholder="Active" className="border-none focus:outline-none w-64   lg:w-24 h-4 pl-2 md:w-auto " />
                    ...
                    <div>
                        <div className='flex flex-row items-center    lg:justify-center space-x-1 md:space-x-2 lg:space-x-2'>
                            <h3 className='px-0 md:px-0 lg:px-2 py-1'>Total records: <span className='pl-0 md:pl-1 lg:pl-1'>4</span> </h3>
                            <div className="relative">
                                ...
                                >
                                    <div className="bg-headerGray  text-headingTextColor rounded-lg shadow-lg w-72 md:w-96 lg:w-96">
                                        <h3 className="text-lg w-full h-16 text-black  font-bold px-2">Add Admin</h3>
                                        <div className="   pb- mx-2 bg-white">
                                            <div className=" space-y-1 p-4 bg-gray-100 rounded shadow-md w-full max-w-md mx-auto">
                                                ...
                                                <div className="flex items-center">
                                                    <label className="w-32 font-medium text-gray-700">Password</label>
                                                    <input
                                                        type="password"
                                                        placeholder="Password"
                                                        className="w-full h-6 border border-gray-300 p-2 rounded placeholder:text-sm outline-none focus:ring focus:ring-blue-200"
                                                ...
                                                <div className="flex items-center">
                                                    <label className="w-32 font-medium text-gray-700">Confirm Password</label>
                                                    <input
                                                        type="password"
                                                ...
                                                <div className="flex items-center relative group">
                                                    <label className="w-32 font-medium text-gray-700">Layout</label>
                                                    <input
                                                        type="search"
                                                    ...
                                                    <ul className="hidden group-hover:block bg-gray-200 mt-2 rounded shadow-lg border border-black absolute w-32 top-5 left-full">
                                                        <li className="px-4 py-2 border-b border-black hover:bg-gray-100">User</li>
                                                        <li className="px-4 py-2 border-b border-black hover:bg-gray-100">Agent</li>
                                                        <li className="px-4 py-2 border-b border-black hover:bg-gray-100">Sub-agent</li>
                                                        <li className="px-4 py-2 border-b border-black hover:bg-gray-100">Admin</li>
                                                        <li className="px-4 py-2 border-b border-black hover:bg-gray-100">Sub-Admin</li>
                                                        <li className="px-4 py-2 hover:bg-gray-100">Master</li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className='text-center'>
                                                    <button className='bg-yellow-400 px-14 py-1 text-center'>Create</button>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex justify-end px-6 py-3 border-t">
                                                ...
                                                <button
                                                    className="ml-2 bg-gray-900 text-white px-4 py-2 rounded hover:text-yellow-200"
                                                >
                                                    Save
                                                </button>
                                            </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-300">
                                <thead className="bg-headerGray text-headingTextColor">
                                    <tr>
                                        <th className="border-y bg-headerGray border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">Account</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">Credit Ref.</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">Balance</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-2 py-2 text-left text-sm font-medium uppercase">Exposure</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-2 py-2 text-left text-sm font-medium uppercase">Avail. Bal.</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-2 py-2 text-left text-sm font-medium uppercase">Player Balance</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-4 py-2 text-left text-sm font-medium uppercase">Ref. P/L</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-12 py-2 text-center text-sm font-medium uppercase">Status</th>
                                        <th className="border-y bg-headerGray border-gray-300 px-12 py-2 text-center text-sm font-medium uppercase">Actions</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {data.map((row, index) => (
                                        <tr key={index}>
                                            <td className="border-b px-4 py-2 whitespace-nowrap text-sm text-gray-700">
                                                ...
                                                <button className='w-6 h-6 bg-green-500  font-sans text-white text-xs rounded-sm'>AD</button><span className='text-blue-500 pl-2'>{row.Account}</span>
                                            </td>
                                            ...
                                            <td className="border-b px-2 py-2 whitespace-nowrap text-sm text-gray-700">{row.availBalance}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border-b px-4 py-2 whitespace-nowrap text-sm text-gray-700">8.40,933.62</td>
                                        <td className="border=b px-4 py-2 whitespace-nowrap text-sm text-red-700">1000.00</td>
                                        <td className="border-b px-2 py-2 whitespace-nowrap text-sm text-gray-700">200.00</td>
                                        <td className="border-b px-2 py-2 whitespace-nowrap text-sm text-gray-700">800.00</td>
                                        <td className="border-b px-4 py-2 whitespace-nowrap text-sm text-gray-700">500.00</td>
                                        <td className="border-b px-4 py-2 whitespace-nowrap text-sm text-gray-700">+300.00</td>
