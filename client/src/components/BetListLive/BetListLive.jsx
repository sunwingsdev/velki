...
const placeholderTexts = ['Select user', 'Search Event', 'Select Market', 'Select Currency'];
        ...
        <div>
            ...
            <div className="bg-adminBackground min-h-screen">
                    ...
                    <div className="m-0 space-y-2   px-1 py-1 border-b border-black">
                        <ul className="flex flex-row overflow-x-auto md:flex-row lg:flex-row sm:text-left text-xs items-start">
                            {items.map((item, index) => (
                                <li key={index} className="flex font-bold flex-row md:w-1/2 lg:w-auto items-center gap-1 mb-2">
                                    <span className="break-words">{item}</span>
                                    <input className="w-3 h-3 mr-1 text-white rounded-full border border-black flex items-center justify-center  " type="radio" name="" id="" />
                        ...
                        <div className="mt-4">
                            <div className="w-full sm:w-9/12 md:w-6/12 lg:w-auto md:space-y-2 lg:space-x-4 ml-1 md:ml-1 lg:ml-0 mb-4 flex flex-col md:flex-wrap lg:flex-row md:justify-center lg:justify-start items-start lg:items-center">
                                <div className="mb-2  sm:mb-0">
                                    <input className="text-xs sm:text-sm md:w-28 lg:w-36  w-24 h-7 p-2 rounded-sm outline-none placeholder:text-gray-400" type="search" placeholder="search here" />
                                </div>
                                {[...Array(4)].map((_, index) => (
                                ...
                                <div className="flex flex-row items-center gap-1 w-full sm:w-auto mb-2 sm:mb-0">
                                    ...
                                    <select className='text-xs text-gray-400 sm:text-sm w-full sm:w-24 h-10 p-2 rounded-sm outline-none'>
                                ...
                                <div className="mt-2 sm:mt-0">
                                    <p className="text-xs text-gray-400 font-semibold lg:text-xs">Total Records: 113</p>
                                </div>
                            </div>
                            <button className="bg-black font-bold text-yellow-500 p-2 rounded-sm mt-2 sm:mt-4">Refresh</button>
                        </div>
                    </div>

                    <div className="font-sans ">
                        <ul className="py-4">
                            <li className="w-full pl-2 font-bold py-1 bg-textBackground text-white">UnMatched</li>
                            <li className="bg-white  text-black pl-2 py-1">You have no bets in this time period</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pb-16 mx-3 bg-navbarBackground">
                    <ul>
                        <li className="w-full font-bold  pl-2 py-1 bg-textBackground text-white ">Matched</li>
                    </ul>
                ...
                <div className="bg-navbarBackground mx-3 flex flex-col items-center justify-center  ">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-lg font-bold text-gray-700">Games not found. Please include API.</p>
                    </div>
                </div>
            </div>
