            ...
            <div className="mt-4">
              <div className="w-full sm:w-9/12 md:w-6/12 lg:w-auto md:space-y-2 lg:space-x-4 ml-1 md:ml-1 lg:ml-0 mb-4 flex flex-col md:flex-wrap lg:flex-row md:justify-center lg:justify-start items-start lg:items-center">
                <div className="mb-2  sm:mb-0">
                  <input
                    className="text-xs sm:text-sm md:w-28 lg:w-36  w-24 h-7 p-2 rounded-sm outline-none placeholder:text-gray-400"
                    type="search"
                ...
                <div className="flex flex-row items-center gap-1 w-full sm:w-auto">
                  ...
                  <input
                    className="text-xs sm:text-sm w-full sm:w-36 h-10 p-2 rounded-sm outline-none"
                    type="search"
                    placeholder="search here"
                  />
                </div>
                <div className="mt-2 sm:mt-0">
                  <p className="text-xs text-gray-400 font-semibold lg:text-xs">
                    Total Records: 113
                  </p>
                </div>
              </div>
