  ...
  return (
    <div>
      ...
      <div className="min-h-screen font-sans ">
        ...
        <div className="bg-adminBackground pt-2">
          <ul className="flex flex-row overflow-x-auto mx-1 bg-navbarBackground md:flex-row lg:flex-row sm:text-left text-xs items-start">
        ...
        <div className="mx-1">
          <div className="flex flex-row overflow-x-auto lg:flex-row items-center gap-3">
            <div className="flex flex-row items-center">
              <h3 className="pr-1">Bet status:</h3>
              <input
                className="border border-black p-2 w-28 h-4 text-xs"
                type="search"
                name=""
                id=""
                placeholder="setteled"
              />
            </div>
            <h3 className="pr-1">Period:</h3>
            <input
              className="border border-black p-2 py-3 w-40 h-4 placeholder:text-xs "
              type="date"
              name=""
              id=""
              placeholder="2022/02/23"
            />
            <p>to</p>
            <input
              className="border border-black p-2 py-3 w-40 h-4 "
              type="date"
              name=""
              id=""
              placeholder="2022/02/23"
            ...
            <button className="border px-2   border-black ">
              just for today
            </button>
            ...
            <button className="border p-2 bg-black text-yellow-400 border-black text-xs">
              Show Default
            </button>
            <button className="border p-2 bg-black text-yellow-400 border-black text-xs">
              Get History
            ...
            <p>last:</p>
            <input
              className="border  border-black p-3 w-40 h-4 placeholder:text-xs"
              type="datetime"
              name=""
              id=""
              placeholder="10 tues"
          ...
          <div className="mt-4 gap-2 ">
            <div className="w-full sm:w-9/12 lg:w-auto lg:space-x-4 ml-1 md:ml-1 lg:ml-0 mb-4 space-y-2 md:space-y-2 lg:space-y-0 flex flex-col md:flex-wrap lg:flex-row md:justify-center lg:justify-start items-start lg:items-center">
              <div className="mb-2 sm:mb-0">
                <input
                  className="text-xs sm:text-sm border border-black w-full sm:w-24 h-10 p-2 rounded-sm outline-none placeholder:text-xs"
                  type="search"
              ...
              <div className="flex flex-row items-center w-full sm:w-auto ">
                <h3 className="pr-1">stack &gt;=</h3>
                <input
                  className="border border-black p-2 w-28 h-10 text-xs"
                  type="search"
                  name=""
                  id=""
                  placeholder="0"
        ...
        <div className="mb-16">
          <ul className="flex flex-row bg-gray-400 overflow-x-auto whitespace-nowrap">
