...
const LiveGame = () => {
    return (
        ...
        <h1 className="text-center text-xl font-bold bg-yellow-500 h-10">Live Game</h1>
            ...
            <div className="mx-1">
                ...
                <div className="flex flex-row overflow-x-auto scroll-visible lg:flex-row items-center gap-3">
                    ...
                    <button className="border p-2 bg-black text-yellow-400 border-black text-xs">Show Default</button>
                    <button className="border p-2 bg-black text-yellow-400 border-black text-xs">Get History</button>
                    <p>last:</p>
