          ...
          <div className="mx-3 bg-navbarBackground">
            <div className="pb-3 ">
              ...
              <div className="flex flex-row overflow-x-auto lg:flex-row items-center mt-3 gap-3">
                ...
                <button className=" px-2 bg-white text-gray-400 font-semibold    ">
                  Just for today
                </button>
                ...
                <button className="border p-2 bg-black text-yellow-400 font-bold border-black text-xs">
                  Show Default
                </button>
                <button className="border p-2 bg-black text-yellow-400 font-bold border-black text-xs">
                  Get History
                ...
                <div className="mt-4 gap-2 ">
                  <div className="w-full sm:w-9/12 lg:w-auto lg:space-x-4 ml-1 md:ml-1 lg:ml-0 mb-4 space-y-2 md:space-y-2 lg:space-y-2 flex flex-col md:flex-wrap lg:flex-row md:justify-center lg:justify-start items-start lg:items-center">
                    <div className="mb-2 sm:mb-0">
                      <input
                        className="text-xs mt-3 sm:text-sm w-full sm:w-24 h-10 p-2 rounded-sm outline-none placeholder:text-xs"
                        type="search"
                    ...
                    <div className="flex flex-row items-center w-full sm:w-auto ">
                      ...
                      <input
                        className=" outline-none  p-2 w-28 h-10 text-xs"
                        type="search"
                        name=""
                        id=""
                        placeholder="0"
