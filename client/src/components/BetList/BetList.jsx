...
const placeholderTexts = ['Select User', 'Select Event', 'Select Market', 'Select Currency'];
                        ...
                        <div className="flex flex-row overflow-x-auto lg:flex-row items-center mt-3 gap-3">
                            <div className="flex flex-row items-center">
                                ...
                                <select className='p-2 text-gray-400 font-semibold  text-xs outline-none border '>
                                    <option className='' value='settled'>Settled</option>
                            ...
                            <input className=" p-2 py-3 w-40 h-4 placeholder:text-xs  " type="date" name="" id="" placeholder="" />
                            <p className='text-gray-400 font-semibold'>to</p>
                            <input className=" p-2 py-3 w-40 h-4  " type="date" name="" id="" placeholder="" />

                            <button className=" px-2 bg-white text-gray-400 font-semibold    ">Just for today</button>


                            <button className=" px-2 bg-white text-gray-400 font-semibold     ">From Yesterday</button>
