            ...
            <div className="space-y-4 bg-adminBackground min-h-screen  font-semibold">
               ...
               <ul className=" pl-2 flex flex-row  overflow-x-auto lg:flex-row sm:text-left  items-center gap-6">
                    <span className="flex flex-row items-center gap-1 ">
                        <li>Default span</li>
                        <button className="w-4 h-4   text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                ...
                <div className="m-0 md:m-4 lg:m-20">
                    <div className="flex flex-col items-center justify-center   md:flex-row lg:flex-row space-y-4 md:space-y-0 lg:space-y-0 md:space-x-5 lg:space-x-5">
                        <div className="w-9/12 lg:w-1/3 md:h-80  lg:h-64 border  border-black border-opacity-15" >
                                ...
                                <div className=" flex flex-col lg:flex-row justify-center space-x-3">
                                    <div className="pl-3 lg:pl-0">
                                        ...
                                        <div className="flex flex-row  space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs " type="search" name="" id="" placeholder="10000" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-row space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="0" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col  lg:flex-row justify-center space-x-3">
                                    <div className="pl-3 lg:pl-0">
                                        ...
                                        <div className="flex flex-row space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="2" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                                    ...
                                    <div>
                                        <h3>Bet Delay</h3>
                                        <div className="flex flex-row space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 text-xs" type="search" name="" id="" placeholder="5" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div className=" flex flex-col pl-3   lg:pl-2">
                                <h3 className="">No of  Minutes in <br /> play</h3>
                                <div className="flex flex-row  space-x-1">
                                    <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="0" />
                                    <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                        ...
                        <div className="w-9/12 lg:w-1/3 h-80 lg:h-64 border   border-black border-opacity-15" >
                            <div>
                                ...
                                <div className=" flex flex-col lg:flex-row justify-center space-x-3">
                                    <div className="pl-3 lg:pl-0">
                                        <h3>Bet min rate</h3>
                                        <div className="flex flex-row  space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="20" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div className="flex flex-col  lg:flex-row justify-center space-x-3">
                                <div className="pl-3 lg:pl-0">
                                    <h3>Max Stake </h3>
                                    <div className="flex flex-row space-x-1">
                                        <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="20000" />
                                        <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                                ...
                                <div>
                                    <h3>Max Profit</h3>
                                    <div className="flex flex-row space-x-1">
                                        <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="30000" />
                                        <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div>
                                <div className=" flex flex-col pl-3 lg:pl-2  ">
                                    ...
                                    <div className="flex flex-row  space-x-1"> 
                                        <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="100000" />
                                        <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                        ...
                        <div className="w-9/12 lg:w-1/3 h-80 lg:h-64 border  border-black border-opacity-15" >
                            <div>
                                ...
                                <div className=" flex flex-col lg:flex-row justify-center space-x-3">
                                    <div className="pl-3 lg:pl-0">
                                        <h3>Min stake</h3>
                                        <div className="flex flex-row  space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="1" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                                    ...
                                    <div>
                                        <h3> max stake</h3>
                                        <div className="flex flex-row space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="500000" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col  lg:flex-row justify-center space-x-3">
                                    <div className="pl-3 lg:pl-0">
                                        <h3>Max loss </h3>
                                        <div className="flex flex-row space-x-1">
                                            <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="200000" />
                                            <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div className="flex  flex-col lg:flex-row justify-center space-x-3">
                                ...
                                <div>
                                    <h3>Commission %</h3>
                                    <div className="flex flex-row space-x-1">
                                        <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="5" />
                                        <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                            ...
                            <div>
                                <div className=" flex flex-col pl-3 lg:pl-2 ">
                                    ...
                                    <div className="flex flex-row  space-x-1">
                                        <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="" />
                                        <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
                    ...
                    <div className=" w-9/12 md:w-4/12 lg:w-auto lg:space-x-4 ml-8 md:ml-1 lg:ml-0 mb-0 md:mb-4 lg:mb-0 flex mt-6 flex-col lg:flex-row md:justify-center lg:justify-start  items-center  p-4">
                        ...
                        <div className="pl-0 lg:pl-0">
                            <h3>Max profit</h3>
                            <div className="flex flex-row  space-x-1">
                                <input className="w-40 h-4 border border-black pl-1 placeholder:text-xs" type="search" name="" id="" placeholder="3" />
                                <button className="w-4 h-4  text-white rounded-full border border-black flex items-center justify-center hover:bg-blue-600 transition duration-300">
